...
#%% Check overseed conditions and send alert
...
#%% Check flood conditions and send alert
...
for flood_conditions in [flood_conditions_2019, flood_conditions_2020]:
    condition1 = (df_with_cumulative_totals['rain_3h'] >= flood_conditions['rain_3h'])
    condition2 = (df_with_cumulative_totals[['rain_24h', 'rain_48h', 'rain_72h', 'rain_96h', 'rain_120h']] >= flood_conditions[['rain_24h', 'rain_48h', 'rain_72h', 'rain_96h', 'rain_120h']]).any(axis=1)
    
    potential_flood_conditions[i] = df_with_cumulative_totals[condition1 & condition2]
    i += 1
...
if len(potential_flood_times) > 0:
    ...
    msg_text = f"The following times are forecasted to meet/exceed flood conditions:\n\n{formatted_string}"
